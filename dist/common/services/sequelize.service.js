...
var log = debug_1.default('app:sequelize-service');
var SequelizeService = /** @class */ (function () {
    function SequelizeService() {
        ...
        this.connectWithRetry = function () { return __awaiter(_this, void 0, void 0, function () {
            var sequelize, error_1, retrySeconds;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        log('Attempting Postgres connection (with retry if needed)');
                        sequelize = new sequelize_1.Sequelize(this.sequelizeOptions);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        error_1 = _a.sent();
                        retrySeconds = 5;
                        log("Postgres connection unsuccessful\n        (will retry #" + ++this.count + " after " + retrySeconds + " seconds):", error_1);
    ...
    SequelizeService.prototype.getSequelize = function () {
        var _this = this;
        if (this.sequelize) {
            this.sequelize.authenticate().then(function () {
                ...
                var sequelize = new sequelize_1.Sequelize(_this.sequelizeOptions);
