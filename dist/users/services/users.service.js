...
var users_dao_1 = __importDefault(require("../dao/users.dao"));
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.putById = function (id, resource) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, users_dao_1.default.putUserById(id, resource)];
            });
        });
    };
    UsersService.prototype.patchById = function (id, resource) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, users_dao_1.default.patchUserById(id, resource)];
            });
        });
    };
